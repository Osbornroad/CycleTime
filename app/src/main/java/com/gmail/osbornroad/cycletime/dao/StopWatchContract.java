...
public class StopWatchContract {
    public static final class EmployeeEntry implements BaseColumns {
        ...
        public static final String COLUMN_EMPLOYEE_ORDER_NUMBER = "employeeOrderNumber";
    ...
    public static final class ProcessEntry implements BaseColumns {
        ...
        public static final String COLUMN_PROCESS_ORDER_NUMBER = "processOrderNumber";
    ...
    public static final class MachineEntry implements BaseColumns {
        ...
        public static final String COLUMN_MACHINE_ORDER_NUMBER = "machineOrderNumber";
    ...
    public static final class PartsEntry implements BaseColumns {
        ...
        public static final String COLUMN_PARTS_ORDER_NUMBER = "partsOrderNumber";
